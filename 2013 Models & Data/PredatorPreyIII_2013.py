...
params.add('a', value=k1, min=0, max=100)
...
print("\nFit report for time period 0-65 h, where b = 0\n")
report_fit(result)
...
def ode_solver1(tspan1, initial_conditions1, params1):
    ...
    k1, a, b = params1['k1'].value, params1['a'].value, params1['b'].value
...
params1.add('a', value=k1, min=0, max=100)
...
plt.savefig('PredatorPreyIII2013_Plot.png',bbox_inches='tight', dpi=300)