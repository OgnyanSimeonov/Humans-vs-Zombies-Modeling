...
rxnrate=function(t,c,parms){
  ...
  r=rep(0,length(c))
  r[1]=-k1*0.5*(sin(t*pi/12 +1.5)+1)*c["H"]*c["Z"]
  r[2]=-k2*0.5*(sin(t*pi/12 +1.5)+1)*c["W"]*c["Z"]
  r[3]= k1*0.5*(sin(t*pi/12 +1.5)+1)*c["H"]*c["Z"]+k2*0.5*(sin(t*pi/12 +1.5)+1)*c["W"]*c["Z"]-b*c["Z"] #dcB/dt
  r[4]= b*c["Z"] #dcC/dt
...
cinit=c(H=55, W= 14,Z=1,C=2)
t=df$time
parms=list(k1=4.604e-03,k2=2.550e-04,b=-1.853e-03)
...
parms=c(k1=4.604e-03,k2=2.550e-04,b=-1.853e-03)
# fitting
