...
#------------------------------------------------------------------------------
#DEFINE THE MODELS FOR THE FIRST TIME PERIOD (0-65h)
...
initW1 = sol1[len(t1)-1, 1]
initZ1 =  sol1[len(t1)-1, 2]-12
initC1 = sol1[len(t1)-1, 3]
int_cond1 = [initH1, initW1, initZ1, initC1]
...
sol1 = odeint(ode_model1, int_cond1, t2, args=(k1, k2, b))

plt.plot(t2,sol1[:,0]+sol1[:,1],'b-')
plt.plot(t2,sol1[:,2],'g-')
plt.plot(t2,sol1[:,3],'r-')

plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0.)
plt.savefig('HWZC2012_Plot.png',bbox_inches='tight', dpi=300)
