...
Code for the Predator-Prey II Model
-------------------------------------------------------------------------------
...
params1.add('a', value=a, min=0, max=10)
...
params1 = Parameters()
params1.add('k1', value=k1, min=0, max=5)
params1.add('a', value=a, min=0, max=5)
params1.add('b', value=b, min=0, max=5)
...
sol2 = odeint(ode_model1, int_cond1, t2, args=(k1, a, b))

plt.plot(t2,sol2[:,0],'b-')
plt.plot(t2,sol2[:,1],'g-')
plt.plot(t2,sol2[:,2],'r-')

plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0.)
plt.savefig('HZC2012_Plot.png', bbox_inches='tight', dpi=300)